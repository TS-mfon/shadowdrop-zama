...
export function ShadowDashboard() {
  ...
  return <section className="dashboardGrid">
    <div className="infoCard large"><ShieldCheck/><h2>Issuer dashboard</h2><p>Create a token, define eligible wallets, lock/fund TokenOps airdrops, and let recipients claim from available airdrop pages.</p><div className="ctaRow"><Link className="primaryLink" href="/token/create"><Plus size={15}/> Create token</Link><Link className="primaryLink" href="/airdrops/create">Create airdrop</Link></div></div>
